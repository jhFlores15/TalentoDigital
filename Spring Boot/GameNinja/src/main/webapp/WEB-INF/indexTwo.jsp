    ...
    <div class="row">
        <div class="row">
            ...
            <div class="col text-end">
                <form action="/gold/reset" method="post"><button class="btn btn-primary">Reset</button></form>
            </div>
        </div>
    ...
    <div class="row text-center">
        <div class="col">
            <form action="/gold" method="post">
                <input type="text" class="form-control w-25" name="type" hidden value="farm">
                <h5>Farm</h5>
        ...
        <div class="col">
            <form action="/gold" method="post">
                <input type="text" class="form-control w-25" name="type" hidden value="cave">
                <h5>Cave</h5>
                <p>(earns 5-10 gold)</p>
                <button class="btn btn-primary">Find Gold!</button>
            </form>
        ...
        <div class="col">
            <form action="/gold" method="post">
                <input type="text" class="form-control w-25" name="type" hidden value="house">
                <h5>House</h5>
                <p>(earns 2-5 gold)</p>
                <button class="btn btn-primary">Find Gold!</button>
            </form>
        ...
        <div class="col">
            <form action="/gold" method="post">
                <input type="text" class="form-control w-25" name="type" hidden value="casino">
                <h5>Casino</h5>
        ...
        <div class="col">
            <form action="/gold" method="post">
                <input type="text" class="form-control w-25" name="type" hidden value="spa">
                <h5>Spa</h5>
                <p>(takes 5-20 gold)</p>
                <button class="btn btn-primary">Find Gold!</button>
            </form>
